...
from src.schemas.actividad import ActividadResumen
from src.schemas.categoria import CategoriaResumen
from src.schemas.dia import DiaResumen, DiaUpdate
