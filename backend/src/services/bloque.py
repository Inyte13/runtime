...
from src.crud.dia import create_dia, read_dia
from src.models.bloque import Bloque
from src.models.dia import Dia
from src.schemas.bloque import BloqueCreate, BloqueUpdate
from src.services.actividad import validar_actividad
